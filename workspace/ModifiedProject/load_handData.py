...
def calc_handData(path):
        ...
        #myfunc.printline(vel_excNone_df)
        ...
        posFrmBody_excNone_wrist_df = posInImg_excNone_y_R_df.copy()
        ...
        handData_df[joint_x_L_labels] = posFrmWrist_excNone_x_L_df[joint_x_L_labels]
        handData_df[joint_y_L_labels] = posFrmWrist_excNone_y_L_df[joint_y_L_labels]
        handData_df[joint_x_R_labels] = posFrmWrist_excNone_x_R_df[joint_x_R_labels]
        handData_df[joint_y_R_labels] = posFrmWrist_excNone_y_R_df[joint_y_R_labels]
